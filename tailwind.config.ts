  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        glass:
          '0 8px 32px rgba(99, 102, 241, 0.1), inset 0 0 32px rgba(255,255,255,0.5), 0 0 0 1px rgba(255,255,255,0.1)',
        'glass-hover':
          '0 20px 60px rgba(99, 102, 241, 0.2), inset 0 0 32px rgba(255,255,255,0.6), 0 0 0 1px rgba(99, 102, 241, 0.2)',
    ...
    function ({ addUtilities }: { addUtilities: Function }) {
      addUtilities({
        ...
        '.glass-button': {
          ...
          '&:hover': {
            'box-shadow':
              '0 12px 40px rgba(99, 102, 241, 0.15), inset 0 0 32px rgba(255,255,255,0.6)',
