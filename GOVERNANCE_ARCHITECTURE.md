...
_This document supersedes all prior phase-based governance documentation._
_Governance architecture is defined by the actual code in `src/lib/agents/governance/`._
