...
import { BuildSimulator, createStandardBuildConfig, CORE_INVARIANTS } from './core/simulator';
import { BuildConfig, AgentConfig, ChaosConfig, BuildSnapshot } from './core/types';
...
describe('CHAOS: Large Inputs', () => {
  it('1000 agents should not crash', { timeout: 60000 }, () => {
    const sim = new BuildSimulator(42);
