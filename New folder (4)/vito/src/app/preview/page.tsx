...
export default function PreviewPage() {
  ...
  const testimonials = [
    { name: 'Alex Chen', feedback: 'OLYMPUS transformed our workflow. 10x faster development!', rating: 5 },
    { name: 'Sarah Miller', feedback: 'The AI agents are incredible. Best investment we made.', rating: 5 },
        ...
        <div className="text-white">
          ...
          <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-900/20 via-[#0a0a0f] to-blue-900/20">
            ...
            <div className="relative z-10 text-center px-6 max-w-5xl">
              ...
              <p className="text-xl text-white/60 mb-8 max-w-2xl mx-auto">
                40 AI agents working together to transform your ideas into production-ready code in minutes.
              </p>
          ...
          <section className="py-24 px-6">
            <div className="max-w-6xl mx-auto">
              ...
              <p className="text-center text-white/60 mb-16">Everything you need to build at lightning speed</p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  { title: '40 AI Agents', desc: 'Specialized agents for every task', icon: '🤖' },
                  { title: 'Real-time Generation', desc: 'Watch code being written live', icon: '⚡' },
                  { title: 'Quality Assurance', desc: 'Automatic testing & validation', icon: '✅' },
          ...
          <section className="py-24 px-6 bg-gradient-to-b from-transparent via-violet-900/10 to-transparent">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="bg-white/[0.03] backdrop-blur-xl p-12 rounded-3xl border border-white/10">
                <div className="text-yellow-400 text-2xl mb-4">{'★'.repeat(testimonials[currentTestimonial].rating)}</div>
                <p className="text-2xl text-white/90 mb-6">"{testimonials[currentTestimonial].feedback}"</p>
                <p className="text-violet-400 font-semibold">— {testimonials[currentTestimonial].name}</p>
                  ...
                  {testimonials.map((_, i) => (
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-all ${
                        i === currentTestimonial ? 'bg-violet-500 w-8' : 'bg-white/20 hover:bg-white/40'
                      }`}
                    />
                  ))}
                </div>
          ...
          <main className="flex-1 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {[
                ...
                { label: 'Success Rate', value: '99.2%', change: '+0.5%', color: 'text-emerald-400' },
              ].map((stat, i) => (
                <div key={i} className="bg-white/[0.03] backdrop-blur-xl p-6 rounded-xl border border-white/10">
            ...
            <div className="bg-white/[0.03] backdrop-blur-xl rounded-xl border border-white/10 p-6">
              ...
              <div className="space-y-4">
                {[
                  { name: 'Marketing Landing Page', status: 'Completed', time: '2 min ago', agents: 38 },
                  { name: 'E-commerce Dashboard', status: 'In Progress', time: '5 min ago', agents: 40 },
                  ...
                  <div key={i} className="flex items-center justify-between p-4 bg-white/[0.02] rounded-lg">
                    <div>
                      ...
                      <div className="text-sm text-white/40">{build.agents} agents • {build.time}</div>
                    </div>
              ...
              {[
                {
                  name: 'Starter',
                  price: 'Free',
                  features: ['5 builds/month', '10 AI agents', 'Community support', 'Basic templates'],
                  cta: 'Get Started',
                  popular: false
                },
                {
                  name: 'Pro',
                  price: '$49/mo',
                  features: ['Unlimited builds', '40 AI agents', 'Priority support', 'Premium templates', 'API access'],
                  cta: 'Start Trial',
                  popular: true
                },
                {
                  name: 'Enterprise',
                  price: 'Custom',
                  features: ['Everything in Pro', 'Custom agents', 'Dedicated support', 'SLA guarantee', 'On-premise option'],
                  cta: 'Contact Sales',
                  popular: false
                },
              ].map((plan, i) => (
