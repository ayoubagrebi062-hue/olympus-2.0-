...
export async function POST() {
  ...
  try {
    ...
    if (!execSqlError) {
      ...
      results.push({ step: 'exec_sql_check', success: true, details: 'exec_sql function available' });
      ...
      return NextResponse.json({
        ...
        results,
        errors: schemaErrors,
        message: 'Cannot execute SQL programmatically. Please run the schema SQL in Supabase Dashboard.',
