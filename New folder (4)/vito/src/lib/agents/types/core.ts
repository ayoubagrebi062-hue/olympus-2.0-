...
/** Build phases */
export type BuildPhase = 'discovery' | 'conversion' | 'design' | 'architecture' | 'frontend' | 'backend' | 'integration' | 'testing' | 'deployment';

/** Agent tiers (which model to use) */
export type AgentTier = 'opus' | 'sonnet' | 'haiku';

/** Agent status */
export type AgentStatus = 'idle' | 'initializing' | 'running' | 'waiting' | 'completed' | 'failed' | 'skipped';
...
export type AgentId =
  ...
  | 'psyche' | 'scribe' | 'architect_conversion' | 'conversion_judge'
