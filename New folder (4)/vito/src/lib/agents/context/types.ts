...
/** Build state */
export type BuildState = 'created' | 'queued' | 'running' | 'paused' | 'completed' | 'failed' | 'canceled';
...
export interface ContextUpdateEvent {
  type: 'agent_started' | 'agent_completed' | 'phase_completed' | 'feedback_added' | 'state_changed';
  buildId: string;
  agentId?: AgentId;
  phase?: BuildPhase;
  timestamp: Date;
