    ...
    outputSchema: {
      ...
      properties: {
        ...
        architecture: {
          type: 'object',
          properties: {
            pattern: { type: 'string', description: 'monolith | microservices | serverless | modular-monolith | event-driven' },
        ...
        multiTenancy: {
          ...
          properties: {
            ...
            isolation: { type: 'string', description: 'none | row-level | schema-level | database-level' },
...
`,
    outputSchema: {
      ...
      properties: {
        ...
        mock_data: { type: 'object', description: 'Realistic sample data for all tables and charts' },
      },
    },
    maxRetries: 2,
    timeout: 60000,
