...
const mockPromptService = {
  ...
  getPromptHistory: vi.fn().mockResolvedValue([
    { id: 'prompt-uuid-1', version: 1, avgQualityScore: 7.0 },
  ]),
  getPromptVersions: vi.fn().mockResolvedValue([
    { id: 'prompt-uuid-1', version: 1, status: 'active' },
  ]),
};
...
describe('PerformanceAnalyzer', () => {
  ...
  describe('analyzeAgent', () => {
    ...
    it('should detect declining trend', async () => {
      const decliningData = [
        { agent_quality_metrics: [{ overall_score: 8 }], status: 'completed', tokens_used: 1000, duration_ms: 1000 },
        { agent_quality_metrics: [{ overall_score: 7 }], status: 'completed', tokens_used: 1000, duration_ms: 1000 },
        { agent_quality_metrics: [{ overall_score: 6 }], status: 'completed', tokens_used: 1000, duration_ms: 1000 },
        { agent_quality_metrics: [{ overall_score: 5 }], status: 'completed', tokens_used: 1000, duration_ms: 1000 },
      ];
    ...
    it('should detect quality issues', async () => {
      const lowQualityData = [
        { agent_quality_metrics: [{ overall_score: 4 }], status: 'completed', tokens_used: 1000, duration_ms: 1000 },
        { agent_quality_metrics: [{ overall_score: 3 }], status: 'completed', tokens_used: 1000, duration_ms: 1000 },
        { agent_quality_metrics: [{ overall_score: 5 }], status: 'completed', tokens_used: 1000, duration_ms: 1000 },
      ];
    ...
    it('should detect reliability issues', async () => {
      const unreliableData = Array(10).fill(null).map((_, i) => ({
