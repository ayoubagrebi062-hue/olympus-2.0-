...
import { createQualityGateSystem, QualityRuleRegistry, CheckpointManager, GateEvaluator, RollbackEngine, QualityTrendAnalyzer } from './quality-gates';
...
export function createTenXSystem(): TenXSystem {
  ...
  const sagas = createSagaOrchestrator();
