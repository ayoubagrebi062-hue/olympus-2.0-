...
export function isBuildEvent(event: SSEEvent): event is BuildStartedEvent | BuildProgressEvent | BuildCompletedEvent {
  return event.type === 'build_started' || event.type === 'progress' || event.type === 'build_completed';
}
...
export function isAgentEvent(event: SSEEvent): event is AgentStartedEvent | AgentCompletedEvent | AgentErrorEvent {
  return event.type === 'agent_started' || event.type === 'agent_completed' || event.type === 'agent_error';
}
