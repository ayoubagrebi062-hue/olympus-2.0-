...
export type Feature =
  | 'custom_domain' | 'white_label' | 'priority_support' | 'advanced_analytics'
  | 'team_collaboration' | 'api_access' | 'sso' | 'audit_logs' | 'export_code'
  | 'multiple_environments' | 'custom_branding' | 'dedicated_support'
