...
export function paymentFailedEmail(props: PaymentFailedProps): { subject: string; html: string; text: string } {
  const { userName, planName, amount, currency, retryDate, updatePaymentUrl, failureReason } = props;
