...
export const orders: Order[] = [
  ...
  },
  {
    ...
    items: [
      { productId: 'prod_3', name: 'Leather Laptop Bag', quantity: 1, price: 189.50 },
  ...
  },
  {
    ...
    items: [
      { productId: 'prod_4', name: 'Yoga Mat Premium', quantity: 1, price: 79.99 },
    ],
    total: 79.99,
    status: 'pending',
...
export const dailyRevenue: DailyRevenue[] = [
  { date: '2024-12-01', revenue: 1250.00, orders: 8 },
  { date: '2024-12-02', revenue: 1890.50, orders: 12 },
  { date: '2024-12-03', revenue: 2340.00, orders: 15 },
  { date: '2024-12-04', revenue: 3100.75, orders: 18 },
  { date: '2024-12-05', revenue: 2780.25, orders: 16 },
  { date: '2024-12-06', revenue: 3520.00, orders: 22 },
  { date: '2024-12-07', revenue: 4200.50, orders: 25 },
  { date: '2024-12-08', revenue: 3890.00, orders: 21 },
  { date: '2024-12-09', revenue: 4560.75, orders: 28 },
  { date: '2024-12-10', revenue: 5120.00, orders: 32 },
  { date: '2024-12-11', revenue: 4780.50, orders: 29 },
  { date: '2024-12-12', revenue: 5450.25, orders: 35 },
  { date: '2024-12-13', revenue: 6200.00, orders: 38 },
