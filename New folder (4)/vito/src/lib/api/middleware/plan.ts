...
const PLAN_FEATURES: Record<PlanTier, string[]> = {
  ...
  pro: ['basic_projects', 'basic_builds', 'custom_domains', 'priority_builds', 'team_collaboration', 'advanced_analytics', 'api_access'],
  business: ['basic_projects', 'basic_builds', 'custom_domains', 'priority_builds', 'team_collaboration', 'advanced_analytics', 'api_access', 'sso', 'audit_logs', 'sla'],
  enterprise: ['basic_projects', 'basic_builds', 'custom_domains', 'priority_builds', 'team_collaboration', 'advanced_analytics', 'api_access', 'sso', 'audit_logs', 'sla', 'dedicated_support', 'custom_integrations'],
};

/**
 * Plan limits.
 */
const PLAN_LIMITS: Record<PlanTier, { projects: number; builds: number; deploys: number; members: number }> = {
