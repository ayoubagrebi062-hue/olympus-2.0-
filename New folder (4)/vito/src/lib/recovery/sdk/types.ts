...
export type RetryStrategy =
  ...
  | { readonly type: 'exponential-backoff'; readonly maxAttempts: number; readonly baseDelay: Milliseconds; readonly maxDelay: Milliseconds; readonly jitter: boolean }
  | { readonly type: 'linear-backoff'; readonly maxAttempts: number; readonly initialDelay: Milliseconds; readonly increment: Milliseconds }
  | { readonly type: 'custom'; readonly maxAttempts: number; readonly getDelay: (attempt: number) => Milliseconds };
