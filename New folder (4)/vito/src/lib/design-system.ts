...
export const tailwind = {
  ...
  glassCardHover: 'bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl hover:border-white/20 hover:bg-white/[0.05] transition-all duration-200',
  glassCardInteractive: 'bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl hover:border-violet-500/50 hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(124,58,237,0.2)] transition-all duration-300 cursor-pointer',

  // Buttons (50X with glow and lift)
  buttonBase: 'px-6 py-3 rounded-xl font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-zinc-900 active:scale-[0.98]',
  buttonPrimary: 'bg-violet-600 text-white hover:bg-violet-700 shadow-lg shadow-violet-500/25 hover:shadow-xl hover:shadow-violet-500/30 hover:-translate-y-0.5',
  buttonSecondary: 'bg-white/10 text-white hover:bg-white/20 border border-white/10 hover:border-white/20',
  buttonGhost: 'text-white/70 hover:text-white hover:bg-white/5',
  buttonGradient: 'bg-gradient-to-r from-violet-600 to-purple-600 text-white hover:from-violet-500 hover:to-purple-500 shadow-lg shadow-violet-500/25 hover:shadow-xl hover:-translate-y-0.5',
  buttonOutline: 'border border-violet-500/50 text-violet-400 hover:bg-violet-500/10 hover:border-violet-500',

  // Inputs (violet focus)
  inputBase: 'w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-all duration-200',
  ...
  gradientText: 'bg-gradient-to-r from-violet-400 via-purple-400 to-blue-400 bg-clip-text text-transparent',
  ...
  // Focus states (violet)
  focusRing: 'focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-zinc-900',

  // Badges
  badge: 'px-3 py-1 bg-violet-500/20 border border-violet-500/30 rounded-full text-violet-300 text-sm font-medium',
  badgeSuccess: 'px-3 py-1 bg-green-500/20 border border-green-500/30 rounded-full text-green-300 text-sm font-medium',
  badgeWarning: 'px-3 py-1 bg-amber-500/20 border border-amber-500/30 rounded-full text-amber-300 text-sm font-medium',
  badgeError: 'px-3 py-1 bg-red-500/20 border border-red-500/30 rounded-full text-red-300 text-sm font-medium',
