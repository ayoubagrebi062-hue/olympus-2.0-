...
export const PHASE_INFO: Record<AgentPhase, { name: string; number: number; color: string; description: string }> = {
  discovery: {
    name: 'Discovery',
    number: 1,
    color: '#8B5CF6',
...
export const AGENTS: Agent[] = [
  // Phase 1: Discovery (5 agents)
  {
    ...
    capabilities: ['Market Analysis', 'Competitor Research', 'Trend Detection', 'Gap Identification'],
  },
  {
    id: 'empathy',
    name: 'EMPATHY',
    ...
    capabilities: ['Persona Creation', 'User Journey Maps', 'Pain Point Analysis', 'Behavioral Insights'],
  },
  {
    id: 'strategos',
    name: 'STRATEGOS',
    ...
    capabilities: ['Feature Prioritization', 'MVP Definition', 'Roadmap Planning', 'Scope Management'],
  },
  {
    id: 'scope',
    name: 'SCOPE',
    ...
    capabilities: ['Boundary Definition', 'Constraint Analysis', 'Trade-off Evaluation', 'Focus Optimization'],
  },
  {
    id: 'venture',
    name: 'VENTURE',
