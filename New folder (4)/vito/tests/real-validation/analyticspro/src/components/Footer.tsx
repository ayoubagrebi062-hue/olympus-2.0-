      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm">
              Powerful analytics for modern businesses. Make data-driven decisions with confidence.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/dashboard/analytics" className="hover:text-white transition">Analytics</Link></li>
              <li><Link href="/dashboard/revenue" className="hover:text-white transition">Revenue</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">
            &copy; 2024 AnalyticsPro. All rights reserved.
          </p>
