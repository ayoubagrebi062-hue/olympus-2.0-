-- ═════════════════════════════════════════════════════════════════════════════
-- OLYMPUS CONDUCTOR - COMPLETE MIGRATION PACKAGE
-- ═════════════════════════════════════════════════════════════════════════════
--
-- This file combines all 6 CONDUCTOR-related migrations for execution in order.
-- Run this ONCE in your Supabase SQL Editor.
--
-- EXECUTION ORDER:
-- 1. Phase 2 Audit Tables (agent_verifications, audit_logs)
-- 2. Checkpoints (build_checkpoints, resume history)
-- 3. Prompt Management (dynamic prompts, A/B testing, versioning)
-- 4. Build Plans (main build planning tables)
-- 5. Build Plans Normalized (fixes JSONB anti-pattern)
-- 6. Build State Machines (persistent state for recovery)
--
...
-- ║  Purpose: Build plan integration with phases and agents                     ║
-- ╚═════════════════════════════════════════════════════════════════════════════╝
...
-- ╔═════════════════════════════════════════════════════════════════════════════╗
-- ║  MIGRATION 6: BUILD STATE MACHINES                                          ║
...
-- ═════════════════════════════════════════════════════════════════════════════
--
-- ✅ ALL 6 CONDUCTOR MIGRATIONS EXECUTED
--
-- Summary:
-- - 19 tables created
...
-- - Dynamic prompt management with A/B testing
-- - Build state machines for recovery
--
-- Next Steps:
-- 1. Run: npm test (should see 284+ tests passing)
-- 2. Start using CONDUCTOR for intelligent build orchestration
