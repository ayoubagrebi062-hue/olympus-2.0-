  ...
  public: {
    ...
    Enums: {
      ...
      build_status:
        ...
        | 'canceled'
        | 'timeout';
      credit_transaction_type: 'purchase' | 'usage' | 'refund' | 'bonus' | 'adjustment' | 'expiry';
      deployment_status:
        | 'pending'
        | 'preparing'
        | 'building'
        ...
        | 'rolled_back'
        | 'stopped';
      deployment_target: 'olympus' | 'vercel' | 'netlify' | 'railway' | 'cloudflare' | 'export';
      domain_status: 'pending' | 'verifying' | 'verified' | 'failed' | 'expired';
      environment_type: 'development' | 'staging' | 'preview' | 'production';
      file_category: 'image' | 'video' | 'audio' | 'document' | 'code' | 'archive' | 'other';
      invitation_status: 'pending' | 'accepted' | 'declined' | 'expired' | 'revoked';
      log_level: 'debug' | 'info' | 'warn' | 'error' | 'fatal';
      plan_tier: 'free' | 'starter' | 'standard' | 'pro' | 'business' | 'enterprise';
      project_status: 'draft' | 'building' | 'ready' | 'deployed' | 'archived' | 'deleted';
      subscription_status:
        | 'trialing'
        | 'active'
        | 'past_due'
