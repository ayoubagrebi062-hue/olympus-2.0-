...
export const openApiSpec = {
      ...
      get: {
        ...
        responses: {
          200: {
            description: 'Success',
            content: {
              'application/json': { schema: { $ref: '#/components/schemas/ProjectListResponse' } },
            },
          },
        },
      },
    ...
    '/api/builds': {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            'application/json': { schema: { $ref: '#/components/schemas/StartBuildRequest' } },
          },
        },
        responses: {
          201: {
  ...
  components: {
    ...
    schemas: {
      ...
      StartBuildRequest: {
        type: 'object',
        required: ['projectId', 'description', 'tier'],
        properties: {
          projectId: { type: 'string', format: 'uuid' },
          description: { type: 'string' },
          tier: { type: 'string', enum: ['starter', 'professional', 'ultimate', 'enterprise'] },
        },
      },
      BuildResponse: {
        type: 'object',
