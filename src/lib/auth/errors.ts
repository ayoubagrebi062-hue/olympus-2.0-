...
export const AUTH_ERRORS: Record<AuthErrorCode, ErrorDefinition> = {
  ...
  AUTH_103: {
    ...
    userMessage: 'Your account has been temporarily locked due to too many failed attempts.',
  },
  AUTH_104: {
    code: 'AUTH_104',
    status: 403,
  ...
  AUTH_106: {
    ...
    userMessage: 'The provided token is invalid.',
  },
  AUTH_107: {
    code: 'AUTH_107',
    status: 401,
  ...
  AUTH_109: {
    ...
    userMessage: 'Please enter your two-factor authentication code.',
  },
  AUTH_110: {
    code: 'AUTH_110',
    status: 401,
  ...
  AUTH_203: {
    ...
    userMessage: 'This invitation link is invalid.',
  },
  AUTH_204: {
    code: 'AUTH_204',
    status: 410,
    message: 'Invitation expired',
    userMessage: 'This invitation has expired. Please request a new one.',
  },
  AUTH_205: {
    code: 'AUTH_205',
    status: 409,
  ...
  AUTH_303: {
    ...
    userMessage: 'You do not have access to this project.',
  },
  AUTH_304: {
    code: 'AUTH_304',
    status: 404,
  ...
  AUTH_500: {
    ...
    status: 400,
    message: 'OAuth error',
    userMessage: 'Unable to complete sign in with this provider.',
  },
  AUTH_501: {
    code: 'AUTH_501',
    status: 502,
    message: 'OAuth provider error',
    userMessage: 'The authentication provider is currently unavailable.',
  },
  AUTH_502: {
    code: 'AUTH_502',
    status: 400,
    message: 'OAuth callback error',
    userMessage: 'Authentication callback failed. Please try again.',
  },
  AUTH_503: {
    code: 'AUTH_503',
    status: 409,
    message: 'Account linking failed',
    userMessage: 'Unable to link this account. It may already be linked to another user.',
  },
  AUTH_504: {
    code: 'AUTH_504',
    status: 401,
  ...
  AUTH_603: {
    ...
    userMessage: 'You have reached the maximum number of active sessions.',
  },
  ...
  AUTH_700: {
    ...
    userMessage: 'Unable to process invitation.',
  },
  AUTH_701: {
    code: 'AUTH_701',
    status: 400,
  ...
  AUTH_703: {
    ...
    userMessage: 'The owner cannot be removed from the organization.',
  },
  AUTH_704: {
    code: 'AUTH_704',
    status: 403,
  ...
  AUTH_705: {
    ...
    userMessage: 'You have reached the maximum number of team members for your plan.',
  },
  AUTH_706: {
    code: 'AUTH_706',
    status: 400,
    message: 'Invalid role',
    userMessage: 'The specified role is invalid.',
  },
  AUTH_707: {
    code: 'AUTH_707',
    status: 403,
    message: 'Cannot demote higher role',
    userMessage: 'You cannot change the role of a user with higher permissions.',
  },
  ...
  AUTH_803: {
    ...
    userMessage: 'One or more fields exceed the maximum length.',
  },
  AUTH_804: {
    code: 'AUTH_804',
    status: 400,
    message: 'Field too short',
    userMessage: 'One or more fields are too short.',
  },
  ...
  AUTH_902: {
    ...
    userMessage: 'An external service is unavailable. Please try again.',
  },
  AUTH_903: {
    code: 'AUTH_903',
    status: 500,
