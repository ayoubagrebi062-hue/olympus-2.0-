 ...
 */
type HasParams<K extends RouteKey> = ExtractParamNames<RoutePath<K>> extends never ? false : true;
...
type AppLinkProps<K extends RouteKey> =
  HasParams<K> extends true ? AppLinkPropsWithParams<K> : AppLinkPropsNoParams<K>;
