...
export const PHASE_CONFIGS: PhaseConfig[] = [
  {
    phase: 'discovery',
    agents: ['oracle', 'empathy', 'venture', 'strategos', 'scope'],
    parallel: false,
    optional: false,
    minTier: 'starter',
  },
  {
    phase: 'conversion',
    agents: ['psyche', 'scribe', 'architect_conversion', 'conversion_judge'],
    parallel: false,
    optional: false,
    minTier: 'starter',
  },
  {
    phase: 'design',
    agents: ['palette', 'grid', 'blocks', 'cartographer', 'flow', 'artist'],
    parallel: false,
    optional: false,
    minTier: 'starter',
  },
  {
    phase: 'architecture',
    agents: ['archon', 'datum', 'nexus', 'forge', 'sentinel', 'atlas'],
    parallel: false,
    optional: false,
    minTier: 'starter',
  },
  ...
  {
    phase: 'backend',
    agents: ['engine', 'gateway', 'keeper', 'cron'],
    parallel: true,
    optional: false,
  ...
  {
    phase: 'integration',
    agents: ['bridge', 'sync', 'notify', 'search'],
    parallel: true,
    optional: true,
    minTier: 'professional',
  },
  {
    phase: 'testing',
    agents: ['junit', 'cypress', 'load', 'a11y'],
    parallel: true,
    optional: true,
    minTier: 'ultimate',
  },
  {
    phase: 'deployment',
    agents: ['docker', 'pipeline', 'monitor', 'scale'],
    parallel: true,
    optional: true,
    minTier: 'enterprise',
  },
