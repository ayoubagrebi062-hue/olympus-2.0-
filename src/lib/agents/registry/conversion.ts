...
`,
      ...
      properties: {
        psychology_profile: {
          ...
          properties: {
            primary_trigger: {
              type: 'string',
              description: 'fear|greed|guilt|exclusivity|salvation',
            },
  ...
  },
  {
    ...
    name: 'SCRIBE',
    description:
      'Conversion copywriting using proven frameworks (PAS, HSO, AIDA, CJN) with niche-specific knowledge',
    phase: 'conversion',
    tier: 'opus',
...

{
  ...
  },
  {
    ...
    description:
      'Quality scoring engine that validates all conversion content before passing to next phase',
    phase: 'conversion',
    tier: 'sonnet',
