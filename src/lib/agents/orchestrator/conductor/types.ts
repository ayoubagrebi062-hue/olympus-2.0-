 ...
 */
export type Status = 'success' | 'streaming' | 'waiting' | 'offline' | 'cancelled' | 'error';
...
export type ProgressStage = 'starting' | 'thinking' | 'streaming' | 'validating' | 'done';
...
export type TelemetryType = 'request' | 'success' | 'error' | 'cache_hit' | 'offline' | 'retry';
