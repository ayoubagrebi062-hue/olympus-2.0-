...
export const FEATURE_PATTERNS: Record<string, FeatureRequirement> = {
  ...
  kanban: {
    ...
    patterns: [/column|lane|board/i, /drag.*drop|dnd|draggable/i, /useDrag|useDrop|DndContext/i],
  ...
  dashboard: {
    ...
    patterns: [/stat.*card|metric/i, /chart|graph/i, /overview|summary/i],
  ...
  dataTable: {
    ...
    patterns: [/<table|<Table|DataTable/i, /thead|tbody|th|td/i, /columns.*rows|pagination/i],
  ...
  form: {
    ...
    patterns: [/<form|<Form|useForm/i, /onSubmit|handleSubmit/i, /validation|schema/i],
  ...
  lightTheme: {
    ...
    patterns: [/bg-white|bg-slate-[0-2]|bg-gray-[0-2]/i, /background:\s*#f|background:\s*white/i],
    minOccurrences: 3,
    critical: false,
  },
