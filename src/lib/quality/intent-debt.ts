...
export class IntentDebtManager {
  ...
  getUnresolvedDebt(): IntentDebtEntry[] {
    return this.ledger.entries.filter(e => !e.resolved).sort((a, b) => b.debtWeight - a.debtWeight);
  }
 ...
 */
export function checkMonotonicity(previousScore: number, currentScore: number): MonotonicityCheck {
