...
function calculateCertificateHash(
  cert: Omit<DecisionCertificate, 'certificateHash' | 'signature'>
): string {
...
export function verifyCertificate(
  ...
  const expectedHash = calculateCertificateHash(
    partialCert as Omit<DecisionCertificate, 'certificateHash' | 'signature'>
  );
