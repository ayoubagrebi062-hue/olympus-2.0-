 ...
 * Track a click event
 */
export function trackClick(elementId: string, properties: Record<string, unknown> = {}): void {
  trackEvent('click', {
    elementId,
    ...properties,
  });
 ...
 */
export function trackFormSubmit(formId: string, properties: Record<string, unknown> = {}): void {
 ...
 * Track login event
 */
export function trackLogin(properties: { method: 'email' | 'google' | 'github' }): void {
 ...
 * Track feature usage
 */
export function trackFeatureUsage(feature: string, properties: Record<string, unknown> = {}): void {
 ...
 * Track build export
 */
export function trackBuildExported(properties: { buildId: string; format: string }): void {
