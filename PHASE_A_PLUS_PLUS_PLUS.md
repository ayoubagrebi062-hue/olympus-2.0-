...
const riskRules = [
  ...
  },
  {
    level: 'high',
    condition: () =>
      pattern.inferredScope === 'global' && pattern.warningTypes.includes('scope_underestimation'),
  },
  {
    level: 'high',
    condition: () =>
  ...
  {
    level: 'low',
    condition: () => pattern.inferredScope === 'project' && pattern.scopeConsistency === 'mixed',
  },
  {
    level: 'low',
